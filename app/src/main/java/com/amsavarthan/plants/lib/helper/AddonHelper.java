...
public class AddonHelper
{
	...
	public static final String[] ADDON_BROADCAST = {
		"com.amsavarthan.plants.grow.ACTION_UPDATER",
		"com.amsavarthan.plants.grow.ACTION_SAVE_PLANTS"
	};
	...
	public static final String[] ADDON_ACTIVITIES = {
		"com.amsavarthan.plants.grow.ADDON_CONFIGURATION"
	};

	/**
	 * Sends `com.amsavarthan.plants.grow.ACTION_SAVE_PLANTS` broadcast for plant list data
	 * @param context
	 */
	public static void broadcastPlantList(Context context)
	{
		...
		new Thread(new Runnable()
		{
			@Override public void run()
			{
				...
				Intent saveRequest = new Intent("com.amsavarthan.plants.grow.ACTION_SAVE_PLANTS");
				saveRequest.addFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES);
				saveRequest.putExtra("com.amsavarthan.plants.grow.PLANT_LIST", plantListData);
				saveRequest.putExtra("com.amsavarthan.plants.grow.ENCRYPTED", MainApplication.isEncrypted());
	...
	/**
	 * Sends `com.amsavarthan.plants.grow.ACTION_SAVE_PLANTS` broadcast for image added/deleted
	 * @param context
	...
	public static void broadcastImage(Context context, String imagePath, boolean deleted)
	{
		Intent saveRequest = new Intent("com.amsavarthan.plants.grow.ACTION_SAVE_PLANTS");
		saveRequest.addFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES);
		saveRequest.putExtra(deleted ? "com.amsavarthan.plants.grow.IMAGE_DELETED" : "com.amsavarthan.plants.grow.IMAGE_ADDED", imagePath);
		saveRequest.putExtra("com.amsavarthan.plants.grow.ENCRYPTED", MainApplication.isEncrypted());
