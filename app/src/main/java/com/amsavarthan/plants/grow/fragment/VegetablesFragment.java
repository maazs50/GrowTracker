...
public class VegetablesFragment extends Fragment {
    ...
    private void getDatafromJSON(String json) {
        ...
        try {
            ...
            for (int i = 0; i < data.length(); i++) {
                ...
                String Telugu=c.getString("Telugu");
                String Kannada=c.getString("Kannada");
                ...
                plantNames.setTelugu(Telugu);
                plantNames.setKannada(Kannada);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getDatafromJSON(loadJSONFromAsset("vegetables"));
