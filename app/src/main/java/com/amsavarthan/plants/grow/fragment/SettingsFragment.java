			...
			if (resolveInfos.size() > 0)
			{
				for (final ResolveInfo resolveInfo : resolveInfos)
				{
					try
					{
						...
						final String name = bundle.getString("com.amsavarthan.plants.grow.ADDON_NAME", appName);
						final String version = String.valueOf(bundle.get("com.amsavarthan.plants.grow.ADDON_VERSION"));
						...
						preference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener()
						{
							@Override public boolean onPreferenceClick(Preference preference)
							{
								...
								configIntent.addCategory("com.amsavarthan.plants.grow.ADDON_CONFIGURATION");
