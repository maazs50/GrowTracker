...
import com.amsavarthan.plants.grow.fragment.PinDialogFragment;
import com.amsavarthan.plants.lib.handler.ExceptionHandler;
import com.amsavarthan.plants.lib.helper.EncryptionHelper;
import com.amsavarthan.plants.lib.helper.MigrationHelper;
			...
			new AlertDialog.Builder(this)
				...
				.setPositiveButton("Yes", new DialogInterface.OnClickListener()
				{
					@Override public void onClick(DialogInterface dialogInterface, int i)
					{
						...
						share.putExtra(Intent.EXTRA_EMAIL, new String[]{"amsavarthan.a@gmail.com"});
