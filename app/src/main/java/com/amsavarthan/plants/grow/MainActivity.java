...
import com.amsavarthan.plants.grow.fragment.GardenDialogFragment;
import com.amsavarthan.plants.grow.fragment.PlantListFragment;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener
{
	...
	@Shortcut(id = "add_plant", icon = R.drawable.ic_add_24dp, shortLabel = "Add plant")
	...
	@Override public boolean onNavigationItemSelected(MenuItem item)
	{
		if (item.getItemId() == R.id.website)
		{
			...
			view.setData(Uri.parse("http://lvstore.000webhostapp.com"));
			startActivity(view);
		}
